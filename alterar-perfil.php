                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="user-photo m-b-30">
                          <button class="remove-button" onclick="window.location.href = './php/acao.php?deleteProfilePhoto=1'">Remover</button>
                          <?php echo "<img class='img-fluid' src='images2/{$_SESSION['imagem']}' alt='' />" ?>
                        </div>
                      </div>
                      <div class="col-lg-8">
                            ...
                            <div class="tab-content">
                              <div role="tabpanel" class="tab-pane active" id="1">
                                <div class="basic-information">
                                  <form action="./php/atualizar-perfil.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="email-content">
                                      ...
                                      <span class="contact-email">
                                        <input type="tel" name="telefone" value="<?php echo $_SESSION['telefone'] ?>">
                                      </span>
                                    </div>
